...
class TestQuestions:
    @allure.title('Получаем ответ на вопрос "Сколько стоит?" и сравниваем с ожидаемым')
    ...
    @allure.title('Получаем ответ на вопрос Хочу сразу несколько самокатов! Так можно? и сравниваем с ожидаемым')
    ...
    @allure.title('Получаем ответ на вопрос Как рассчитывается время аренды? и сравниваем с ожидаемым')
    ...
    @allure.title('Получаем ответ на вопрос Можно ли заказать самокат прямо на сегодня? и сравниваем с ожидаемым')
    ...
    @allure.title('Получаем ответ на вопрос Можно ли продлить заказ или вернуть самокат раньше? и сравниваем с ожидаемым')
    ...
    @allure.title('Получаем ответ на вопрос Вы привозите зарядку вместе с самокатом? и сравниваем с ожидаемым')
    ...
    @allure.title('Получаем ответ на вопрос Можно ли отменить заказ? и сравниваем с ожидаемым')
    ...
    @allure.title('Получаем ответ на вопрос Я живу за МКАДом, привезёте? и сравниваем с ожидаемым')
